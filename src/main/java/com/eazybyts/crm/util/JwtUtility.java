...
public class JwtUtility {
	...
	public String generateToken(String userName, Long principalId) throws JOSEException {
		...
		JWTClaimsSet claimsSet = new JWTClaimsSet.Builder().subject(userName).issuer("LMS")
				.expirationTime(new Date(new Date().getTime() + 3600 * 1000)).claim("principalId", principalId).build();
